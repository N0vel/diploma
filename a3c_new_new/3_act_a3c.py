        ...
        with sess.as_default(), sess.graph.as_default():
            while not coord.should_stop():
                ...
                while episode_step_count < max_episode_length:
                    ...
                    s1, r, d = self.env.step(POSSIBLE_ACTIONS[a])
                ...
                if episode_count % 5 == 0 and episode_count != 0:
                    ...
                    summary.value.add(tag='Losses/Policy_1 Loss', simple_value=float(p_l))
                    summary.value.add(tag='Losses/Entropy_1', simple_value=float(e_l))
